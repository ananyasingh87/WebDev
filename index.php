<html>
	...
	<body>
		<h1 id="top" align="center"><strong> Black Holes</strong></h1>
	
	<p> A black hole is a region of spacetime exhibiting gravitational acceleration so strong that nothing—no particles or even electromagnetic radiation such as light—can escape from it. 
	...
	In many ways, a black hole acts like an ideal black body, as it reflects no light. Moreover, quantum field theory in curved spacetime predicts that event horizons emit <a href="https://en.wikipedia.org/wiki/Hawking_radiation"><em>Hawking radiation</em></a>, with the same spectrum as a black body of a temperature inversely proportional to its mass. This temperature is on the order of billionths of a kelvin for black holes of stellar mass, making it essentially impossible to observe. </p>
		
		<br>
		
		<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/BH_LMC.png/450px-BH_LMC.png"  width="400" height="300"> 
		<br>
		<em>Image of a supermassive black hole at the center of Messier87 galaxy.</em>
		
		<br>
		<br>
		
		<p>Some facts about black hole:
		 <ul type="square">
			<li>Mass : ~7 billion times the sun' mass.</li>
			<li>Shadow of M87 black hole: 2.6 times the diameter of the event horizon.</li>
			<li> Considered as a perfect black body</li>
		</ul>
		</p>
		
		<hr width="1170" color="grey">
		
		<p><h3><strong> Event Horizon </strong></h3>
		...
		<br>
		<p><h3><strong> Singularity </strong></h3>
		...
		<thead>
			<tr>
			<th> Supermassive Blackholes</th>
			<th> Intermediate Blackholes</th>
			<th> Stellar Blackholes</th>
			</tr>
		</thead>
		<tbody>
			<tr>
			<td>1ES 2344+514</td>
			<td>Cigar Galaxy (Messier 82, NGC 3034)</td>
			<td>4U 1543-475/IL Lupi</td>
			</tr>
			<tr>
			<td>Sagittarius A*</td>
			<td>Sculptor Galaxy (NGC 253) </td>
			<td>Cygnus X-1 </td>
			</tr>
			<tr>
			<td>Messier 87</td>
		...
		Want to know more? Check this amazing video by Veritasium:<br>
		<iframe width="560" height="315" src="https://www.youtube.com/embed/zUyH3XhpLTo" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		<br>
		...
		<strong> Please give us your valuable feedback. Fill the form:</strong>
		<br>
		<form>
			 Your Name:<input type="text" placeholder="enter your name"> </input>
			<br>
			...
			<br>
			How would you you like to rate this? (1 being minimum and 10 being maximum)
			
			Your rating: <input type="text"> </input>
			<br>
			<h4>Thankyou for your rating!</h4>
			<br>
			<input type="submit" value="Submit my answer"></input>
			<br>
